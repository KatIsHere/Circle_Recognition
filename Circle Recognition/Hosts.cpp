...
double MAiN_HOST(cl_command_queue &queue, cl_context context, cl_device_id &device, 
	...
	// SETTING UP KERNEL ARGUMENTS FOR POLINOMES CALCULATIONS
	err = clSetKernelArg(kernel_polinomes, 0, sizeof(x_input_buffer), (void *)& x_input_buffer);
	checkErr(err, "clSetKernelArg : x(0)");

	err = clSetKernelArg(kernel_polinomes, 1, sizeof(f_input_buffer), (void *)& f_input_buffer);
	checkErr(err, "clSetKernelArg : f(1)");

	err = clSetKernelArg(kernel_polinomes, 2, sizeof(C_buffer), (void *)& C_buffer);
	checkErr(err, "clSetKernelArg : C(2)");

	err = clSetKernelArg(kernel_polinomes, 3, sizeof(A_buffer), (void *)& A_buffer);
	checkErr(err, "clSetKernelArg : A(4)");

	err = clSetKernelArg(kernel_polinomes, 4, sizeof(B_buffer), (void *)& B_buffer);
	checkErr(err, "clSetKernelArg : B(5)");

	err = clSetKernelArg(kernel_polinomes, 5, sizeof(P_buffer), (void *)& P_buffer);
	checkErr(err, "clSetKernelArg : P(6)");

	err = clSetKernelArg(kernel_polinomes, 6, sizeof(cl_uint), &input_width);
	checkErr(err, "clSetKernelArg : width(7)");

	err = clSetKernelArg(kernel_polinomes, 7, sizeof(cl_uint), &polinome_power);
	...
	size_t local[] = { 1, 1, 0 };
	err = clEnqueueNDRangeKernel(queue, kernel_polinomes,
		dim,
		nullptr,
		global, local,
		0, nullptr, nullptr);
	...
	checkErr(err, "clSetKernelArg : start(2)");

	err = clSetKernelArg(kernel_extrems, 3, sizeof(cl_float), &finish);
	checkErr(err, "clSetKernelArg : finish(4)");

	err = clSetKernelArg(kernel_extrems, 4, sizeof(firstDer_buffer), (void *)& firstDer_buffer);
	checkErr(err, "clSetKernelArg : firstDer_buffer(5)");

	err = clSetKernelArg(kernel_extrems, 5, sizeof(secondDer_buffer), (void *)& secondDer_buffer);
	checkErr(err, "clSetKernelArg : secondDer_buffer(6)");

	err = clSetKernelArg(kernel_extrems, 6, sizeof(x_extrems_buffer), (void *)& x_extrems_buffer);
	checkErr(err, "clSetKernelArg : x_extrems_buffer(7)");

	err = clSetKernelArg(kernel_extrems, 7, sizeof(y_extrems_buffer), (void *)& y_extrems_buffer);
	checkErr(err, "clSetKernelArg : y_extrems_buffer(8)");

	err = clSetKernelArg(kernel_extrems, 8, sizeof(cl_float), &Eps);
	checkErr(err, "clSetKernelArg : Eps(8)");

	err = clSetKernelArg(kernel_extrems, 9, sizeof(cl_float), &h);
	checkErr(err, "clSetKernelArg : h(8)");

	int dim_2 = 1;
	size_t global_2[] = { input_hight, 1, 0 };
	size_t local_2[] = { 1, 1, 0 };
	const clock_t perf_start_2 = clock();
	err = clEnqueueNDRangeKernel(queue, kernel_extrems,
		dim_2,
		nullptr,
		global_2, local_2,
		0, nullptr, nullptr);
	...
	const clock_t perf_stop_2 = clock();
...
//void initializeA(cl_program program, cl_command_queue &queue, cl_context context, cl_device_id &device, cl_mem x_input_buffer, cl_double* A, const int& input_hight, const cl_int& power, const cl_int& setSize, cl_int* Y) {
//	/*
//	* Creates decomposed A matrix, wich is the same for every polinome
//	*/
//	int i, j, k;
//	float normalizing = (float)1 / (setSize + 1);
//	cl_int err;
//	cl_kernel kernel_add_pown = clCreateKernel(program, "initA", &err);
//	checkErr(err, "clCreateKernel: kernel_add_pown");
//	cl_kernel kernel_assign = clCreateKernel(program, "assign_Y", &err);
//	checkErr(err, "clCreateKernel: kernel_assignT");
//	cl_kernel kernel_pivot_rows = clCreateKernel(program, "pivot_rows", &err);
//	checkErr(err, "clCreateKernel: kernel_pivot_rows");
//	cl_double* T = new cl_double[power];
//
//	// create buffers
//	cl_mem A_buffer = clCreateBuffer(
//		context,
//		CL_MEM_USE_HOST_PTR,
//		sizeof(cl_double) * input_hight * power,
//		A,
//		&err);
//	checkErr(err, "A_buffer in initialising A");
//
//	cl_mem Y_buffer = clCreateBuffer(
//		context,
//		CL_MEM_USE_HOST_PTR,
//		sizeof(cl_int) * power,
//		Y,
//		&err);
//	checkErr(err, "Y_buffer in initialising A");
//
//	/*	
//	cl_mem T_buffer = clCreateBuffer(
//		context,
//		CL_MEM_USE_HOST_PTR,
//		sizeof(cl_float) * power,
//		T,
//		&err);
//	checkErr(err, "T_buffer in initialising A");*/
//
//	//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//	// Assighning A
//
//	err = clSetKernelArg(kernel_add_pown, 0, sizeof(x_input_buffer), (void *)& x_input_buffer);
//	checkErr(err, "clSetKernelArg : x(0)");
//	err = clSetKernelArg(kernel_add_pown, 1, sizeof(A_buffer), (void *)&A_buffer);
//	checkErr(err, "clSetKernelArg : A(1)");
//
//	err = clSetKernelArg(kernel_add_pown, 3, sizeof(cl_float), &normalizing);
//	checkErr(err, "clSetKernelArg : normalizing(3)");
//	err = clSetKernelArg(kernel_add_pown, 4, sizeof(cl_int), &power);
//	checkErr(err, "clSetKernelArg : j(3)");
//
//	err = clSetKernelArg(kernel_add_pown, 5, sizeof(cl_int), &setSize);
//	checkErr(err, "clSetKernelArg : j(3)");
//	int dim = 1;
//	size_t global[] = { power, 1, 0 };
//	size_t local[] = { 1, 1, 0 };
//	checkErr(err, "clSetKernelArg : x(0)");
//	for (i = 0; i < power; ++i) {
//		err = clSetKernelArg(kernel_add_pown, 2, sizeof(cl_int), &i);
//		checkErr(err, "clSetKernelArg : i(2)");
//
//		err = clEnqueueNDRangeKernel(queue, kernel_assign,
//			dim,
//			nullptr,
//			global, local,
//			0, nullptr, nullptr);
//		checkErr(err, "clEnqueueNDRangeKernel - kernel_pown");
//	}
//
//	err = clFinish(queue);
//	checkErr(err, "clFinish");
//	err = clEnqueueReadBuffer(queue, A_buffer, CL_TRUE, 0, sizeof(cl_double) * power* input_hight, A_buffer, NULL, NULL, NULL);
//	checkErr(err, "clEnqueueReadBuffer : couldn't read from buffer");
//	//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//	
//	int i_max;
...
//	//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//	// Assighning Y[i] = i
//	err = clSetKernelArg(kernel_assign, 0, sizeof(Y_buffer), (void *)& Y_buffer);
//	checkErr(err, "clSetKernelArg : x(0)");
//
//	err = clEnqueueNDRangeKernel(queue, kernel_assign,
//		dim,
...
//		global, local,
//		0, nullptr, nullptr);
//	checkErr(err, "clEnqueueNDRangeKernel - kernel_assign");
//	err = clFinish(queue);
//	checkErr(err, "clFinish");
//
//	err = clEnqueueReadBuffer(queue, Y_buffer, CL_TRUE, 0, sizeof(cl_int) * power, Y, NULL, NULL, NULL);
//	checkErr(err, "clEnqueueReadBuffer : couldn't read from buffer");
//	//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//	err = clSetKernelArg(kernel_pivot_rows, 0, sizeof(Y_buffer), (void *)& Y_buffer);
//	checkErr(err, "clSetKernelArg : x(0)");
//	for (i = 0; i < power; i++) {
//		maxA = 0.;
//		i_max = i;
...
//	err = clReleaseMemObject(A_buffer);
//	checkErr(err, "clReleaseMemObject : A");
//	err = clReleaseMemObject(Y_buffer);
//	checkErr(err, "clReleaseMemObject : A");/*
//	err = clReleaseMemObject(T_buffer);
//	checkErr(err, "clReleaseMemObject : A");*/
//
//
//	delete[]T;
